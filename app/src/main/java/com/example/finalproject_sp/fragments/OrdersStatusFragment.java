...
import com.example.finalproject_sp.adapters.viewpageradapter.ViewPagerAdapter;
import com.example.finalproject_sp.databinding.FragmentOrdersStatusBinding;
import com.example.finalproject_sp.fragments.OrdersFragment;
...
public class OrdersStatusFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragments.add(OrdersFragment.newInstance("/order/un/complete/delivery"));
        fragments.add(OrdersFragment.newInstance("/order/un/complete/delivery"));
        fragments.add(OrdersFragment.newInstance("/order/complete/delivery"));
